...
A clean copy with no projects or machine files lives in **`CFD-Desk/`**. Zip or copy that folder. Refresh it with `pack-portable.ps1`. The other person still double-clicks Setup.bat.
